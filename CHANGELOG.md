...
### Added
- replace hero scrub videos with a WebGL ribbon background
...
### Fixed
- improve WebGL fallback with theme-aware poster and context-loss guards
- restore SEO metadata and structured data
